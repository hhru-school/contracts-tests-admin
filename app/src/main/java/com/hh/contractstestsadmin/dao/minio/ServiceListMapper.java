...
public class ServiceListMapper {
  ...
  public static List<Service> map(Iterable<Result<Item>> bucketItems) throws StandsDaoException {
    Map<String, Item> lastModifiedArtifacts = getLastModifiedArtefacts(bucketItems);
  ...
  @NotNull
  private static Map<String, Item> getLastModifiedArtefacts(Iterable<Result<Item>> bucketItems) throws StandsDaoException {
